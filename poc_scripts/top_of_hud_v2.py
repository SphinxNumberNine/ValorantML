...
text = pytesseract.image_to_string(
    im_bw, config='--psm 13 --oem 3 digits -c tessedit_char_whitelist=0123456789:')
...
def readNumbersTesseract(image):
